...
const services = [
  {
    ...
    description: "Transporte de contenedores dentro de la ciudad y área metropolitana",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="font-sans text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto px-4 sm:px-0">
            Ofrecemos servicios completos de transporte de contenedores con diferentes modalidades para satisfacer todas
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {services.map((service) => {
            ...
            return (
              <Card key={service.id} className="bg-card hover:shadow-lg transition-shadow">
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-2">
                    <IconComponent className="h-6 w-6 sm:h-8 sm:w-8 text-primary" />
                    <Badge variant={service.status === "Premium" ? "default" : "secondary"} className="text-xs">
                      {service.status}
                    </Badge>
                  </div>
                  <img
                  ...
                  <CardDescription className="font-sans text-sm leading-relaxed">{service.description}</CardDescription>
                </CardHeader>
